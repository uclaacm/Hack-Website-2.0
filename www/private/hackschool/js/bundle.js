	...
	var Dashboard = function (_Component) {
		...
		_createClass(Dashboard, [{
			...
			value: function render() {
				...
				if (!this.props.sessions) return _react2.default.createElement(_loading2.default, { message: 'Retrieving projects info...' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function fetchSessions(url) {
		...
		var request2 = _axios2.default.get(url);
		var request = {
			data: {
				success: true,
				error: null,
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "icons" },
						this.props.slidesLink && _react2.default.createElement(
							"span",
							null,
							_react2.default.createElement("i", { className: "fa fa-film", ariaHidden: "true" })
						),
						this.props.videoLink && _react2.default.createElement(
							"span",
							null,
							_react2.default.createElement("i", { className: "fa fa-video-camera", ariaHidden: "true" })
						),
						this.props.blogPostLink && _react2.default.createElement(
							"span",
							null,
